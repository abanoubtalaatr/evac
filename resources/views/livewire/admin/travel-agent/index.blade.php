<main class="main-content">
    ...
    <div class="border-div">
        <div class="b-btm flex-div-2">
            <h4>{{$page_title}}</h4>
            <a style='text-align:center;cursor:pointer' class="button btn-red big" id="addAgentButton">@lang('site.create_new')</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    @include('partial.admin.travel-agent.edit', ['agent' => $record])
                                    <a wire:click="showAgent({{$record->id}})" class="no-btn"><i
    ...
    @include('partial.admin.travel-agent.add')
