...
<div class="container mt-5">
    ...
    <div >
        ...
        <div class="border-dotted border-top-0 border-right-0 border-left-0 mt-3"><strong >Travel agent: <span style="font-size: 27px">{{$paymentTransaction->agent->name}}</span></strong></div>
        <div class="py-1">ACC NBR : {{$paymentTransaction->agent->account_number   }}</div>
        <div>Received the amount of $ {{( \App\Helpers\formatCurrency($paymentTransaction->amount))}}</div>
