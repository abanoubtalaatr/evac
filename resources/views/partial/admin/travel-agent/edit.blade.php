        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group my-2">
                    ...
                    <input disabled type="text" wire:model="form.name" class="form-control" id="name">
                    @error('form.name')<p style='color:red'> {{$message}} </p>@enderror
                </div>

                <div class="form-group my-2">
                    <label for="companyName">Company Name:</label>
                    <input disabled type="text" wire:model="form.company_name" value="{{$agent->company_name}}" class="form-control" id="companyName">
                    @error('form.company_name')<p style='color:red'> {{$message}} </p>@enderror
                </div>
                <div class="form-group my-2">
                    <label for="address">Address : </label>
                    <input disabled type="text" wire:model="form.address" class="form-control" id="address">
                ...
                <div class="form-group my-2">
                    ...
                    <input disabled type="text" wire:model="form.owner_name" class="form-control" id="owner_name">
                ...
                <div class="form-group my-2">
                    ...
                    <input disabled type="text" wire:model="form.iata_no" class="form-control" id="iata_no">
                    @error('form.iata_no')<p style='color:red'> {{$message}} </p>@enderror
                </div>

                <div class="form-group my-2">
                    <label for="finance_no">Finance No : </label>
                    <input disabled type="text" wire:model="form.finance_no" class="form-control" id="finance_no">
                ...
                <div class="form-group my-2">
                    ...
                    <input disabled type="tel" wire:model="form.telephone" class="form-control" id="telephone">
